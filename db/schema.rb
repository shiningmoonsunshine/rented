...
ActiveRecord::Schema[7.0].define(version: 2023_01_24_184523) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["clothes_id"], name: "index_reviews_on_clothes_id"
  ...
  add_foreign_key "reviews", "clothes", column: "clothes_id"
